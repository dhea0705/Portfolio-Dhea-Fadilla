...
const TECH_STACK = ["PHP", "Javascript", "HTML", "Vue JS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/dhea0705" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/dhea-fadilla-6879a934a/" },
  { icon: Instagram, link: "https://www.instagram.com/dh.fddla_?igsh=MXhwMTZtajN6cDV2Yg==" }
];

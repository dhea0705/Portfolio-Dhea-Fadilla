...
const techStacks = [
  ...
  { icon: "vue.png", language: "Vue JS" },
  { icon: "bootstrap.svg", language: "Bootstrap" },
  { icon: "python.png", language: "Python" },
];

// Hardcoded data for projects and certificates
const projects = [
  {
    id: 1,
    Img: "/man2.jpeg", // Update path to public folder
    Title: "Sistem Informasi Akademik Berbasis Web di MAN 2 Aceh Barat",
    Description: "Program ini dirancang untuk menciptakan pengelolaan data yang sangat terorganisir, cepat, tepat, dan bisa diakses kapan saja dan di mana saja.",
    Link: "https://linktoproject1.com",
  },
  {
    id: 2,
    Img: "/inventori.jpeg", // Update path to public folder
    Title: "Inventory Toko Besi Saki Warna",
    Description: "Aplikasi ini bertujuan untuk pengolahan data barang, data pemesanan dan data stok. aplikasi ini juga bisa membuat laporan-laporan data yang keluar, masuk dan pemesanan.",
...
const certificates = [
  {
    Img: "/SERTIFIKATNOMINASIUTUAWARDS2024.jpg", // Update path to public folder
  },
  {
    Img: "/pomdabaru_page-0001.jpg", // Update path to public folder
  },
  {
    Img: "/sertifikatK3.jpg", // Update path to public folder
  },
  {
    Img: "/Sertifikat_PesertaAESTI2024_page-0001.jpg", // Update path to public folder
  },
  {
    Img: "/kaggle.png", // Update path to public folder
  },
  {
    Img: "/SERTIFKAT RAKERWIL_page-0001.jpg", // Update path to public folder
  },
